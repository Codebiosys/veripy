...
Feature: showing off behave
    ...
    Scenario: Test if the demo app fields accept the right data.
        ...
        Then it is not the case that the "optional_field" field is required
        Then the "required_field" field is required
        Then it is not the case that the "required_field" field is not required
    ...
    Scenario: Test that the user can implicitly switch page contexts
        ...
        Then the statement that 'the "Missing Link" is visible' responds with
            """
            The element "Missing Link" was supposed to be visible and was not.
            """
        Then write the "Other Random Number" generated by the system
