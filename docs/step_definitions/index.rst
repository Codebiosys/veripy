...
.. toctree::
    ...
    step_module.veripy.steps
    step_module.veripy.steps.aggregates.actions.auth
    step_module.veripy.steps.aggregates.checks.check_action
    step_module.veripy.steps.aggregates.checks.check_assertion
    step_module.veripy.steps.aggregates.checks.invert_check
    ...
    step_module.veripy.steps.forms.actions.enter_text_into_field
    step_module.veripy.steps.forms.actions.select_option
